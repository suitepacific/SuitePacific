        ...
        <div className="mt-10 rounded-2xl border border-brand-100 bg-brand-50/30 p-5 sm:p-6">
          ...
          <ul className="space-y-2.5">
            <li className="text-sm text-brand-400">
              <Link href="/blog/netsuite-work-order-automation" className="text-accent hover:underline">
                NetSuite work order automation for manufacturing
              </Link>{" "}
              covers SuiteScript automation for component issuance, labor capture, completion transactions, and variance posting.
            </li>
          </ul>
        </div>
