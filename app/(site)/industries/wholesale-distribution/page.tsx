        ...
        <div className="mt-10 rounded-2xl border border-brand-100 bg-brand-50/30 p-5 sm:p-6">
          ...
          <ul className="space-y-2.5">
            <li className="text-sm text-brand-400">
              <Link href="/blog/netsuite-tiered-pricing-scripts" className="text-accent hover:underline">
                NetSuite tiered pricing scripts for wholesale distributors
              </Link>{" "}
              explains how SuiteScript applies volume tiers, customer contracts, and rebate accrual that the standard pricing engine does not handle.
            </li>
          </ul>
        </div>
