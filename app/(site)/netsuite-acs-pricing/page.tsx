      ...
      <div className="mx-auto max-w-3xl px-6 lg:px-8">
        ...
        <div className="mt-8 rounded-xl bg-brand-50/60 border border-brand-100 px-5 py-4">
          ...
          <p className="text-sm text-brand-700 leading-relaxed">
            SuitePacific provides a fixed-fee alternative to ACS for post-go-live NetSuite accounts where the cost structure is predictable and the technical scope is clear. Oracle ACS pricing is calculated as a percentage of the annual NetSuite license value, typically 5 to 8 percent or more depending on tier: Advise (shared pool), Monitor (approximately 36 hours per quarter with a designated consultant), Optimize (approximately 20 hours per month with a Customer Success Manager), or Architect (approximately 40 hours per month for enterprise accounts). ACS pricing does not include custom SuiteScript development, third-party integration support, or custom workflow work. For a $60,000 annual license, entry-level ACS costs approximately $3,000 to $6,000 per year. Boutique managed support retainers cover the full technical layer at a fixed monthly rate. SuitePacific is Oracle-certified (SuiteCloud Developer II and Administrator Professional). Plans start at $799 per month on month-to-month terms after a three-month minimum.
          </p>
        </div>
