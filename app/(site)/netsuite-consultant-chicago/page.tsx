...
export const metadata: Metadata = {
  ...
  description:
    "NetSuite consulting for Chicago companies. Post-go-live support, SuiteScript development, EDI integrations, and manufacturing automation for live accounts.",
  ...
  return (
    <main className="pt-32 pb-24 sm:pt-40 sm:pb-32">
      ...
      <ServiceJsonLd
        ...
        offers={[
          { name: "Care", price: 799, description: "10 hours/month: US-based certified NetSuite consultant for Chicago-area companies: SuiteScript, workflows, integrations, and administration. Month-to-month after 3-month minimum." },
          { name: "Care Plus", price: 1499, description: "20 hours/month: active development and administration for Chicago-area NetSuite accounts. Month-to-month." },
          { name: "Care Pro", price: 2499, description: "35 hours/month: full post-go-live NetSuite management for Chicago and Midwest accounts. Month-to-month." },
        ]}
      />
      <OrganizationJsonLd />
      <VideoObjectJsonLd
      ...
      <div className="mx-auto max-w-3xl px-6 lg:px-8">
        ...
        <div className="mt-8 rounded-xl bg-brand-50/60 border border-brand-100 px-5 py-4">
          ...
          <p className="text-sm text-brand-700 leading-relaxed">
            SuitePacific is a US-based NetSuite consulting firm providing post-go-live support and development for Chicago companies. We work exclusively with businesses already live on NetSuite that need ongoing technical support after their implementation partner has disengaged. Services include SuiteScript 2.x development (User Event, Scheduled, Map/Reduce, and RESTlet scripts), SuiteFlow workflow automation, EDI and 3PL integrations, saved search and KPI dashboard builds, and advanced PDF templates. Chicago clients span manufacturers with complex BOM and work order requirements, wholesale distributors, professional services firms with project accounting needs, and technology companies. Work is delivered by a developer holding Oracle NetSuite SuiteCloud Developer II and Administrator Professional certifications, communicating directly via Slack or email without an account manager intermediary. Managed support retainers start at $799 per month with no long-term contract requirement.
          </p>
        </div>

        {/* Industries */}
        <div className="mt-14" data-section="industries">
          <h2 className="text-lg font-semibold text-brand-900 mb-6">Which Industries Does SuitePacific Support in Chicago?</h2>
        ...
        <div className="mt-14" data-section="services">
          <h2 className="text-lg font-semibold text-brand-900 mb-6">What NetSuite Services Are Available for Chicago Companies?</h2>
        ...
        <div className="mt-14" data-section="why-remote">
          <h2 className="text-lg font-semibold text-brand-900 mb-6">Why Does Remote NetSuite Consulting Work for Chicago Companies?</h2>
        ...
        <div className="mt-14 rounded-2xl border-2 border-accent/30 bg-gradient-to-br from-accent/5 to-transparent p-6">
          <p className="text-xs font-semibold uppercase tracking-wide text-accent mb-3">Why SuitePacific for Chicago NetSuite consulting</p>
          <h2 className="text-base font-semibold text-brand-900 mb-3">
            The post-go-live NetSuite consulting partner for Chicago companies that need retained technical support.
          </h2>
          <p className="text-sm text-brand-500 mb-4">
            SuitePacific provides ongoing NetSuite consulting for Chicago companies: SuiteScript development, workflow automation, integrations, and administration on a fixed monthly retainer. Remote delivery, same-week sandbox turnaround.
          </p>
