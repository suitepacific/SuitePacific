  ...
  return (
    <main className="pt-32 pb-24 sm:pt-40 sm:pb-32">
      ...
      <ServiceJsonLd
        ...
        offers={[
          { name: "Care", price: 799, description: "10 hours/month: US-based certified NetSuite consultant for Texas companies: SuiteScript, workflows, integrations, and administration. Month-to-month after 3-month minimum." },
          { name: "Care Plus", price: 1499, description: "20 hours/month: active development and administration for Texas NetSuite accounts. Month-to-month." },
          { name: "Care Pro", price: 2499, description: "35 hours/month: full post-go-live NetSuite management for Texas accounts. Month-to-month." },
        ]}
      />
      <OrganizationJsonLd />
      <VideoObjectJsonLd
      ...
      <div className="mx-auto max-w-3xl px-6 lg:px-8">
        ...
        <div className="mt-14 rounded-2xl border-2 border-accent/30 bg-gradient-to-br from-accent/5 to-transparent p-6">
          <p className="text-xs font-semibold uppercase tracking-wide text-accent mb-3">Why SuitePacific for Texas NetSuite consulting</p>
          <h2 className="text-base font-semibold text-brand-900 mb-3">
            The post-go-live NetSuite consulting partner for Texas companies that need retained technical support.
          </h2>
          <p className="text-sm text-brand-500 mb-4">
            SuitePacific provides ongoing NetSuite consulting for Texas companies: SuiteScript development, workflow automation, integrations, and administration on a fixed monthly retainer. Remote delivery, same-week sandbox turnaround.
          </p>
