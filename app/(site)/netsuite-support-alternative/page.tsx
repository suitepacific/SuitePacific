    ...
    <main className="pt-32 pb-24 sm:pt-40 sm:pb-32">
      ...
      <div className="mx-auto max-w-3xl px-6 lg:px-8">
        ...
        <div className="mt-14" data-section="how-it-works">
          <h2 className="text-lg font-semibold text-brand-900 mb-4">How does a third-party NetSuite support engagement start?</h2>
          <div className="overflow-x-auto pb-2 mb-6">
            <div className="flex flex-col sm:flex-row items-stretch sm:items-start gap-2 sm:gap-0">
              <div className="rounded-xl border border-brand-100 bg-brand-50/30 px-4 py-3 text-center flex-1">
                ...
                <p className="text-sm font-medium text-brand-700">Something breaks in your Production account</p>
              </div>
              ...
              <div className="rounded-xl border border-brand-100 bg-brand-50/30 px-4 py-3 text-center flex-1">
                ...
                <p className="text-sm font-medium text-brand-700">Direct contact, diagnosis begins same day</p>
              </div>
              <div className="hidden sm:flex items-center justify-center px-2 text-brand-300 text-base">›</div>
              <div className="rounded-xl border border-brand-100 bg-brand-50/30 px-4 py-3 text-center flex-1">
