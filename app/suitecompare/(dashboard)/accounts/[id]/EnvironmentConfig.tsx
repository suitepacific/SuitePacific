                ...
                <div className="space-y-3">
                  <div>
                    ...
                    <input
                      ...
                      placeholder={env.credentialsConfigured ? "•••• leave blank to keep existing" : "From integration record"}
                      className={inputCls}
                      autoComplete="off"
                    />
                  </div>
                  ...
                  <div>
                    <label className={labelCls}>Token Key</label>
                    <input
                      name="tokenKey"
                      type={showSecrets ? "text" : "password"}
                      placeholder={env.credentialsConfigured ? "•••• leave blank to keep existing" : "Access token key"}
                      className={inputCls}
                      autoComplete="off"
                    />
                  </div>
                  <div>
                    <label className={labelCls}>Token Secret</label>
                    <input
                      name="tokenSecret"
                      type={showSecrets ? "text" : "password"}
                      placeholder={env.credentialsConfigured ? "•••• leave blank to keep existing" : "Access token secret"}
                      className={inputCls}
                      autoComplete="off"
                    />
                  </div>
