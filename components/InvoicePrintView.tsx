        ...
        <div className="max-w-2xl mx-auto px-8 py-16">
          ...
          <div className="flex items-start justify-between mb-12">
            <div>
              ...
              <img src="/SuitePacificLogo.PNG" alt="SuitePacific" className="h-20 w-auto object-contain" />
            </div>
          ...
          <div className="border-t border-brand-50 pt-8 mt-12 flex flex-col items-center gap-2">
            {/* eslint-disable-next-line @next/next/no-img-element */}
            <img src="/SuitePacificLogo.PNG" alt="SuitePacific" className="h-10 w-auto object-contain opacity-40" />
