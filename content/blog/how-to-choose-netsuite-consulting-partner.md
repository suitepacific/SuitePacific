...
Most companies need an implementation partner to go live, then a different kind of partner for what comes after. See [NetSuite post-go-live support](/netsuite-post-go-live-support) for what that looks like in practice.
...
The most common reason companies switch [NetSuite consulting partners](/netsuite-consulting-services) is accumulated frustration that was not specific enough to trigger a change. Tickets take longer than they should. Customizations break on releases without warning. The team stops asking for improvements because they expect them to take too long or cost too much. These are all signs that the support relationship is not working, but none of them individually prompts action.
...
For a detailed diagnostic on whether your current support relationship has structural problems, see [8 signs your NetSuite support isn't working](/blog/signs-netsuite-support-not-working).
