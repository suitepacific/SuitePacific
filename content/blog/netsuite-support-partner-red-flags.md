...
## Response time promises without a delivery structure
...
## Vague or missing certification claims
...
## Long-term contracts with no exit path
...
## No documentation of existing customizations
...
## Recommendations that exceed the scope of the problem
