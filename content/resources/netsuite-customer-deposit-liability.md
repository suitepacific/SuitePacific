...
<p style="margin:0;color:#14306b;font-size:0.9rem;line-height:1.6">In NetSuite, a Customer Deposit records an advance payment from a customer as an Other Current Liability — not as revenue. The cash has been received, but the obligation to deliver goods or services has not yet been fulfilled. Revenue is recognized only when the deposit is applied to an invoice after the goods or services are delivered. Until then, the deposit sits on the balance sheet as a liability. Cash received and revenue earned are two different accounting events; NetSuite's Customer Deposit record enforces this distinction correctly.</p>
</div>
