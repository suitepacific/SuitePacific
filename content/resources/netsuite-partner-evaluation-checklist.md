---
title: "NetSuite Support Partner Evaluation Checklist"
description: "A structured checklist for evaluating NetSuite post-go-live support partners. Covers who does the work, certifications, billing model, response time, release handling, and red flags to walk away from."
...
See also: [how to evaluate a NetSuite support partner](/blog/how-to-evaluate-netsuite-support-partner) for a narrative walkthrough of these questions, [red flags when evaluating a NetSuite support partner](/blog/netsuite-support-partner-red-flags) for warning signs to walk away from, and [NetSuite Care plans](/netsuite-care) for SuitePacific's own engagement model and pricing.
